     ...
     - Model Router (model-router.ts): 7 roles mapped to models —
     code-gen/pr-metadata/architect use deepseek-reasoner,
     planning/review/repair/explorer use deepseek-chat
